...
public class SettlementScreen extends Screen {
    ...
    protected void init() {
        ...
        this.villagerListWidget = new VillagerListWidget(
            ...
            listY,
            y + screenHeight - 5,
            24, // Increased item height for better spacing
    ...
    private void discoverStructures() {
        ...
        try {
            ...
            String[] knownStructures = {"lvl1_oak_wall.nbt", "lvl2_oak_wall.nbt", "lvl3_oak_wall.nbt"};
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // Call super.render() - this will render all children INCLUDING the widget ON TOP of sidebar
    ...
    private void drawTabContent(DrawContext context, int x, int y) {
        ...
        switch (activeTab) {
            case OVERVIEW:
                // Overview tab - widgets remain visible but not actively used
                context.drawText(
                    this.textRenderer, 
